...
public class Response<T> {
  ...
  /**
   * Error details when status is not {@link ApiStatus#SUCCESS}
   *
   * @see ErrorDetails
   */
   ...
   */
  public Response(@NonNull ApiStatus status, @NonNull Integer code, T data) {
    this.status = status;
    this.code = code;
    this.data = data;
  }
   ...
   * @param status Status of Api Response.
   * @param code   HttpStatus Code of Api Response.
   * @param errors Error details when status is not {@link ApiStatus#SUCCESS}
   */
  public Response(@NonNull ApiStatus status, @NonNull Integer code, ErrorDetails... errors) {
    this.status = status;
    this.code = code;
